    ...
    public class LanceTextVariation
    {
        ...
        public static bool ChooseTextVariationWhenNotableRefusesToEnlistLance()
        {
            ...
            if (ownerClan == Clan.PlayerClan)
            {
                ...
                if (Globals.LanceSettings.FemalePrejudice && Hero.MainHero.IsFemale && notable.GetRelationWithPlayer() < 5
                ...
                if (Globals.LanceSettings.FemalePrejudice && Hero.MainHero.IsFemale && notable.GetRelationWithPlayer() < 15
                ...
                if (Globals.LanceSettings.FemalePrejudice && Hero.MainHero.IsFemale && notable.GetRelationWithPlayer() < 20)
                {
            ...
            {
                if (Globals.LanceSettings.FemalePrejudice && Hero.MainHero.IsFemale) refusalText = "{=bab_lance_refusal_female_clantier0}A woman without land, speaking of banners and men? You shame yourself. Begone, before you are laughed from the gate.";
            ...
            {
                if (Globals.LanceSettings.FemalePrejudice && Hero.MainHero.IsFemale) refusalText = "{=bab_lance_refusal_female_clantier1}I have heard some talk of you, woman, but this is another man’s land. Take such speech of banners and men elsewhere.";
            ...
            {
                if (Globals.LanceSettings.FemalePrejudice && Hero.MainHero.IsFemale) refusalText = "{=bab_lance_refusal_female_clantier2}I know who you are, yet you stand on another’s land and ask for men as though it were your own — liberties rarely granted, and less so to a woman.";
