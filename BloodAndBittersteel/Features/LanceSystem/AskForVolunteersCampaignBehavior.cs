using BloodAndBittersteel.Features.LanceSystem.Dialogues;
using System;
...
namespace BloodAndBittersteel.Features.LanceSystem
{
    public class AskForVolunteersCampaignBehavior : CampaignBehaviorBase
    {
        ...
        private float GetSuccessChance 
        {
            ...
            {
                float chance = 0f;
                chance += Hero.MainHero.Clan.Tier == 0? 0.1f : 0.2f;
                if (Hero.MainHero.IsFemale && BaBSettings.Instance.FemalePrejudice) chance -= 0.05f;
                return chance; 
            }
        }
        ...
        {                 
            get
            {
                ...
                if (Hero.MainHero.IsFemale && BaBSettings.Instance.FemalePrejudice) maxAmount -= 1;
        ...
        private void AddDialogs(CampaignGameStarter starter)
        {
            ...
            starter.AddPlayerLine("volunteer_take", "volunteers_interested", "volunteer_notable_comment", "I will take them", null, GiveVolunteers, 100, null);
            starter.AddPlayerLine("volunteer_no_take", "volunteers_interested", "volunteer_notable_comment", "I changed my mind", null, null, 100, null);
